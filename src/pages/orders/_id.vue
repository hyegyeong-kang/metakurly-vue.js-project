  ...
  <div class="page-section">
    <div class="container">
      ...
      <div class="widget-box">
        ...
        <h6 class="post-title">주문번호 {{order.id}}</h6>
        결제날짜 {{order.orders_date}}  {{order.status}}
        <div class="divider"></div>
        
        <div class="blog-item"
          v-for="detail in orderDetails" :key="detail.productDTO.id">
          <router-link class="post-thumb" :to="{path: '/products/' + detail.productDTO.id}">
        ...
        {{payment.method}}
        <div class="btn">
          <button id="cancelBtn" @click="cancelOrder">주문취소</button>
