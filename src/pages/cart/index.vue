  ...
  <div class="cart_table">
              ...
              <ul class="cart_list">
                ...
                <li>
                  ...
                  <!--장바구니 리스트-->
                <div :value="cart.cartnum" :key="cart.cartnum" v-for="cart in carts">
                    <li class="cell">
                        <!--상품 체크박스 부분-->
                        <div class="checkbox">
                            <input class="checkbox" name="item_chk" id="item_chk01">
                        ...
                        <div class="opt_info">
                            <div>
                                <div class="price_unit"><span>{{ cart.price }}</span></div>
                            </div>
                            <div class="price_btn">
                                <button class="minus_btn" value="-" v-on:click="minusBtn"></button>
                                <input type="text" class="product_count">
                                <button class="plus_btn" value="-" v-on:click="plusBtn"></button>
                            </div>
